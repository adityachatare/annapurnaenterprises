...
<nav className="navbar navbar-expand-lg navbar-light bg-transperent">
  <NavLink className="navbar-brand" to="/">Annapurna Enterprises</NavLink>
  ...
  <div className="collapse navbar-collapse" id="navbarSupportedContent">
    <ul className="navbar-nav ml-auto">
      ...
      <li className="nav-item">
        <NavLink activeClassName="menu_active" exact className="nav-link" to="/service">Our Services</NavLink>
      </li>
      <li className="nav-item">
